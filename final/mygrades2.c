/*******************************************************************************
 * This is a grade storing and viewing solution with different levels of
 * permission and access. Admin, students and teachers see different menus
 * and can utilise different functions. For ease of use I've included an example
 * database and a few accounts. 
 *
 * UserID: 13276946 Pass: password (student account with filled in info)
 * UserID: teacher  Pass: password (teacher account with subjects assigned)
 * UserID: Admin    Pass: password (admin account)
 *
 * Admins create accounts and assign subjects to teachers and students.
 * Subjects assigned to teachers give them permission to manage the subject
 * (i.e. not all teachers have access to all subjects)
 * Subjects assigned to students become a place to add assignments.
 * Assignments can be managed by admins and teachers. Typing in the appropriate
 * user ID will bring up the interface. Enter student code 13276946 when prompted
 * to view the saved data. I mainly say this as the printouts change based on
 * whether an account is empty or not and it may be difficult for you to add
 * data yourself. The flowcharts give a good idea of where to go.
 * 
*******************************************************************************/
